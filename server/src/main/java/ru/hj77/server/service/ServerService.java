...
public class ServerService {
    ...
    public double withdrawMoneyFromTheCard(Long clientsId, Long cardsId, double money){

        Client client = clientCrudRepository.findById(clientsId)
                .orElseThrow(RuntimeException::new);

        Card card = searchCardByCardId(client, cardsId);
    ...
    public double depositMoneyFromTheCard(Long clientsId, Long cardsId, double money) {
